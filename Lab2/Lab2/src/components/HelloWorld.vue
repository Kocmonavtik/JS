<template>
  <div class="w-full max-w-2xl">
    ...
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" @submit.prevent="someAction1()">

      <div class="grid grid-rows-1 grid-cols-5 gap-4 pb-1">
        <div class="col-span-2">
          <p class="flex items-center text-lg">Ссылка на фото</p>
          <textarea class="form-textarea shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="Image"></textarea>
        </div>
      ...
      <div class="grid grid-cols-3 gap-4 pb-8">
        ...
        <div class="col-span-2">
          <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="SecondName">
        </div>
      </div>
      ...
      <div class="grid grid-cols-3 gap-4 pb-3">
        ...
        <div class="col-span-2">
          <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline " v-model="PhoneNumber"  @blur="isEmailTouched = true" v-bind:placeholder='89990888552'>
        </div>
      </div>

      <transition name="fade">
        <div class="pb-3" v-if="isPhoneError">
          <p class="text-lg text-red-500">Не верный формат номера телефона</p>
        </div>
      </transition>
      ...
      <div class="grid grid-cols-3 gap-4 pb-8">
        ...
        <div class="col-span-2">
          <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="LocationUser">
        </div>
      </div>
      ...
      <div class="grid grid-cols-3 gap-4 pb-3">
        ...
        <div class="col-span-2">
          <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="date" v-model="Birthday">
        </div>
      </div>
      ...
      <div class="grid grid-cols-3 gap-4 pb-3">
        ...
        <div class="col-span-2 grid grid-cols-5 gap-4">
          <div class="col-span-4 ">
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="Salary" >
          </div>
          <div class="relative inline-block w-full text-gray-700">
            <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="Currency">
              <option>Руб</option>
              <option>USD</option>
              <option>EUR</option>
            </select>
      ...
      <div class="grid grid-cols-3 gap-4 pb-3">
        ...
        <div class="col-span-2">
          <div class="relative inline-block w-full text-gray-700">
            <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="Education">
      ...
      <transition name="fade">
        <div v-if="Education !=='Среднее'">
          <div class="grid grid-cols-3 gap-4 pt-3 pb-3">
            ...
            <div class="col-span-2">
              <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="EduInstitution">
            </div>
          </div>
          ...
          <div class="grid grid-cols-3 gap-4 pb-3">
            ...
            <div class="col-span-2">
              <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="Faculty">
            </div>
          </div>
          ...
          <div class="grid grid-cols-3 gap-4 pb-3">
            ...
            <div class="col-span-2">
              <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="Specialization">
            </div>
          </div>
          ...
          <div class="grid grid-cols-3 gap-4 pb-6">
            ...
            <div class="col-span-2">
              <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="YearEnd">
            </div>
          </div>
        </div>
      </transition>
      ...
      <div class="grid grid-cols-3 gap-4 pb-8">
        ...
        <div class="col-span-2">
          <textarea class="form-textarea shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="KeySkills">
      ...
      <div class="grid grid-cols-3 gap-4 pb-8">
        ...
        <div class="col-span-2">
          <textarea class="form-textarea shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="AboutMe">
      ...
      <div class="">
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button" v-on:click="VisibleResume = !VisibleResume">
          {{ButtonMessage}}
        </button>
      </div>
    </form>
...
export default {
  ...
  data () {
    return {
      ...
      Education: 'Высшее',
      Currency: 'Руб',
      PhoneNumber : '9056899840',
      isEmailTouched: false,
      FirstName: 'Иван',
      SecondName: 'Чаплыгин',
      Birthday:  '1999.12.14',
      ImageSrc: 'https://sun9-79.userapi.com/impf/c844418/v844418355/2a2eb/mxRPOakr5CA.jpg?size=400x400&quality=96&sign=ef85992771c2102495cc7b836e1b3911&type=album',
      Email: 'chaplygin141299@gmail.com',
      LocationUser: 'Липецк',
      Salary: '30000',
      EduInstitution: 'ЛГТУ',
      Faculty: 'Факультет автоматизации и информатики',
      Specialization: 'Программная инженерия',
      YearEnd: '2022',
      KeySkills: 'xxxxxxxxxxxxxxxxxxxxxxxxx xxxxxxxxxxxxx xxxxxxxxxxxxx xxxxxxxxxxxxxxxxxxxxx',
      AboutMe: 'xxxxxxxxxxxxxxxxxxxxxxxxx xxxxxxxxxxxxx xxxxxxxxxxxxx xxxxxxxxxxxxxxxxxxxxx',
      VisibleResume: false,
    }
  },
  /*watch: {
