...
<button  type="button"
                 ...
                 v-on:click="info.Education.push(info.NewEducation)">
            Добавить образование
        </button>
            <div class="grid grid-cols-3 gap-4 pb-3" v-for="(Edu, index) in info.Education">
                <p class="flex items-center text-lg">Образование</p>
                <div class="col-span-2">
                    <div class="relative inline-block w-full text-gray-700">
                        <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                v-on:change="onChange"
                                v-model="info.Education[0].classEdu">
            ...
            <transition name="fade">
                <div v-if="info.Education[0].classEdu !='Среднее'">
                    <div class="grid grid-cols-3 gap-4 pt-3 pb-3">
                        <p class="flex items-center text-lg">Учебное заведение</p>
                        <div class="col-span-2">
                            <div class="relative inline-block w-full text-gray-700">
                                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                       v-model="info.Education[0].EduInstitution" v-on:input="onInputUniversities" list="dataUniversities">
                    ...
                    <div class="grid grid-cols-3 gap-4 pb-3">
                        ...
                        <div class="col-span-2">
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                   v-model="info.Education[0].Faculty">
                        </div>
                    </div>
                    <div class="grid grid-cols-3 gap-4 pb-3">
                        ...
                        <div class="col-span-2">
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                   v-model="info.Education[0].Specialization">
                        </div>
                    </div>
                    <div class="grid grid-cols-3 gap-4 pb-6">
                        ...
                        <div class="col-span-2">
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                   v-model="info.Education[0].YearEnd">
                        </div>
                    </div>
                </div>
            </transition>
...
template>
    ...
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="grid grid-cols-3 gap-4 pb-3">
            ...
            <div class="col-span-2">
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                       v-model="info.PhoneNumber"  @blur="info.isPhoneTouched = true" v-bind:placeholder='9990888552'>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
          onChange(){
              if(this.info.Education[0].classEdu=='Среднее'){
                  this.info.Education[0].Faculty=''
                  this.info.Education[0].EduInstitution=''
                  this.info.Education[0].Specialization=''
                  this.info.Education[0].YearEnd=''
              }
          },
            onInputLocation(){
        ...
        mounted() {
            /*axios.get("https://api.vk.com/method/users.get?user_ids=132555922&fields=bdate&access_token=16bd660e592e5759f2a2cdccd3562b4c8613fb4d03cb49ed0012b38f57f4878a9108d6d50d6bc7c6624c9&v=5.131")
                    .then(response => this.info.VK= response.data.response);*/
//https://api.vk.com/method/database.getCountries?need_all=1&count=1000&access_token=16bd660e592e5759f2a2cdccd3562b4c8613fb4d03cb49ed0012b38f57f4878a9108d6d50d6bc7c6624c9&v=5.131
//Россия имеет id=1
//получение основных городов
//https://api.vk.com/method/database.getCities?country_id=1&need_all=0&count=1000&access_token=16bd660e592e5759f2a2cdccd3562b4c8613fb4d03cb49ed0012b38f57f4878a9108d6d50d6bc7c6624c9&v=5.131
/*axios.get("https://api.vk.com/method/database.getCities?country_id=1&need_all=0&count=1000&access_token=16bd660e592e5759f2a2cdccd3562b4c8613fb4d03cb49ed0012b38f57f4878a9108d6d50d6bc7c6624c9&v=5.131")
    .then(response=> this.info.VkCity=response.data.response.items);
}*/
/*}
}
